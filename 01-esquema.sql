...
CREATE TABLE IF NOT EXISTS public.mov_costos_proyectos (
    num_empleado bigint NOT NULL,
    id_proyecto bigint NOT NULL,
    nom_proyecto character varying(250) NOT NULL,
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE public.ctl_costos_tokens TO sysrvia;
...
GRANT USAGE, SELECT ON SEQUENCE public.ctl_costos_tokens_idu_costos_tokens_seq TO sysrvia;
